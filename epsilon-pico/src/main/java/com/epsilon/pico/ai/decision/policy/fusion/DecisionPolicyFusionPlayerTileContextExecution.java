...
import com.epsilon.pico.ai.decision.policy.DecisionPolicyPlayerTileContextExecution;
import com.epsilon.pico.ai.decision.policy.EpsilonPlayerTileContextMixer;
import java.util.ArrayList;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * 4家の牌別文脈をdjl-rocmのPROJECTED_RESIDUAL_MLPで合成する重みを固定したモデルの推論実行。
 *
 * <p>実行計画とパラメーターはパイプライン全体で共有し、各位置は最大 {@code [maxBatch,34,context]} の出力と処理段階 作業領域だけを持つ。{@code
 * maxBatch=4096}、{@code context=64}では、位置ごとの論理入力と確率分布の本体は FLOAT16/BFLOAT16で約68 MiB、FLOAT32で約136
