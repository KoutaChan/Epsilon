...
public final class EpsilonDecisionDuelEvaluator {
   ...
   *
   * @param candidateCheckpointDir 評価対象チェックポイントまたはその親ディレクトリ
   * @param opponentCheckpointDir 固定対戦相手チェックポイントまたはその親ディレクトリ
   ...
   * @throws IOException チェックポイントの解決、読込、または対局実行処理実行に失敗した場合
   */
