...
public final class EpsilonDecisionModelCopies {
  ...
  /**
   * 入力元と独立した固定したモデルを教師値デバイス上に作る。
   *
   * <p>入力元は複製中に更新されないこと。教師値所有の初期化済み配列へ直接複製するため、入力元の管理元や寿命には依存しない。
   */
  ...
  /** 凍結した推論複製モデルのパラメーターを指定精度へ一度だけ変換し、元配列を解放する。 */
