package com.epsilon.major.training;
...
/** 三種類の牌譜形式から同じ Decision 入力と最終順位の教師値が得られることを検証する。 */
public final class RecordPretrainTest {
  ...
  public void allThreeFormatsProduceTheSameDecisionInputsAndFinalRankTeachers() throws Exception {
    ...
    try {
      ...
      var inputs = new ArrayList<List<com.epsilon.major.ai.decision.data.EpsilonDecisionSample>>();
