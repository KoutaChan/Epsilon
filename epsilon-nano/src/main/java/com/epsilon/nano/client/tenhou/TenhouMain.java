package com.epsilon.nano.client.tenhou;
...
public final class TenhouMain {
  ...
  private static final String DEFAULT_CHECKPOINT = "checkpoints/epsilon-nano";

  private TenhouMain() {}

  /** チェックポイントと推論サーバーは接続終了後に生成側で閉じる。 */
  public static void main(String[] args) throws IOException {
    var startup = StartupSettings.read("epsilon-nano", EpsilonSettings.DEFAULT_RESOURCE, args);
