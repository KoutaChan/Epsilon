...
/**
 * Decision の牌譜事前学習のデータ読み込みと実行計画設定です。
 *
 ...
 * @param computePrecision 順伝播/入力の計算精度。BFLOAT16では実行パラメーター/勾配にも適用し、更新はFLOAT32 の更新用パラメーターで行う
 ...
 * @param behaviorCloningCoef 選択した方策 NLLの損失係数
