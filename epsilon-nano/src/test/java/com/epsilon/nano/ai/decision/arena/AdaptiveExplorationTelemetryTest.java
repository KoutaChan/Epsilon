...
import com.epsilon.nano.ai.decision.arena.DecisionAdaptiveExploration.Kind;
import com.epsilon.nano.ai.decision.arena.DecisionAdaptiveExploration.Lookup;
import com.epsilon.nano.ai.decision.arena.DecisionAdaptiveExploration.LookupSource;
import com.epsilon.nano.ai.decision.arena.DecisionAdaptiveExploration.Measurement;
import com.epsilon.nano.ai.decision.arena.DecisionAdaptiveExploration.Observation;
import org.testng.Assert;
import org.testng.annotations.Test;

/** 探索前の不確実性と較正の有無を集計し、強制手や最大確率が同じ行動を適切に扱うことを検証する。 */
public class AdaptiveExplorationTelemetryTest {

  /** 校正済・未校正・強制手を混ぜても、確率距離と選択順位を各集計範囲へ正しく記録する。 */
  @Test
