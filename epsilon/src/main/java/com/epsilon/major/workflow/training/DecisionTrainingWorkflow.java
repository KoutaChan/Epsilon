...
import com.epsilon.major.ai.decision.training.DecisionSelectedPgCampaignResult;
import com.epsilon.major.ai.decision.training.EpsilonDecisionSelectedPgCampaign;
...
public final class DecisionTrainingWorkflow
  ...
  public DecisionSelectedPgCampaignResult execute(WorkflowArguments arguments) throws Exception {
    return EpsilonDecisionSelectedPgCampaign.train(
        arguments.optionalPath(0, Path.of("checkpoints/epsilon")),
