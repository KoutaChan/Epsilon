...
import com.epsilon.nano.config.settings.DecisionSelectedPgCampaignSettings.OptimizerSettings;
import com.epsilon.runtime.DecisionExecutionContext;
import java.io.IOException;
import java.nio.file.Path;
import java.util.Objects;

/** 選択行動の方策勾配学習で、モデル、AdamW、KL に基づく学習率制御をまとめて保持する。 */
final class DecisionLearner implements AutoCloseable {
  ...
  /** 継続更新する作業用チェックポイントからモデル、AdamW、KL 制御器を一組として復元する。 */
