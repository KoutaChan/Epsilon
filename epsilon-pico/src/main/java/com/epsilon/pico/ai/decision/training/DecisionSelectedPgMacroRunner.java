...
import com.epsilon.pico.ai.decision.runtime.DecisionGpuMemoryDiagnostics;
import com.epsilon.pico.ai.decision.runtime.EpsilonDecisionEvaluatorFactory;
import com.epsilon.pico.ai.decision.training.EpsilonDecisionTrainFragmentPipeline.Spool;
import com.epsilon.pico.ai.decision.training.EpsilonDecisionTrainFragmentPipeline.StreamingTrainingPlan;
import com.epsilon.pico.ai.decision.training.EpsilonDecisionTrainFragmentPipeline.TrainCollection;
...
/** 1回の学習サイクルとして、複数モデルとの自己対局、データの逐次読み込みと学習、更新後の検証を実行する。 */
final class DecisionSelectedPgMacroRunner {
  ...
  /** 収集対局単位の学習データの所有権を最後まで管理し、学習サイクルの学習結果とphase別時間を返す。 */
