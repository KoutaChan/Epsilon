...
import com.epsilon.major.config.settings.DecisionSelectedPgCampaignSettings.OptimizerSettings;
import com.epsilon.runtime.DecisionExecutionContext;
import java.io.IOException;
import java.nio.file.Path;
import java.util.Objects;

/** 学習を継続するためのモデル、AdamW の状態、方策更新の KL 制御状態をまとめて管理する。 */
final class DecisionLearner implements AutoCloseable {
  ...
  /** 上書きを繰り返す更新中のチェックポイントからモデル、AdamW、KL 制御処理を一組として復元する。 */
