...
public final class EpsilonUtilityTargets {
  ...
  /** モデルの学習開始時に、保存サンプルとモデルの効用定義が一致することを検証する。 */
   ...
   *
   * @param sampleProfile サンプルに保存された計測結果通し番号
  ...
  /**
   * 順位に基づく効用の定義で最終順位の4分類分布をスカラー価値へ復号する。
   *
   * @param profile 順位効用を持つ計測結果
