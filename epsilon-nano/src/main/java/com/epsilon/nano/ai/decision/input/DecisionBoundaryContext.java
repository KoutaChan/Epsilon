 ...
 * 周辺分布、後半は配牌前に確定している局番号・本場・供託・4人の得点と、その有効マスクである。手牌、山、配牌乱数シードはこの型へ入れられない。
 */
public record DecisionBoundaryContext(
  ...
  /** 重みを固定したGRPと、その推論に使った配牌前公開先頭部分から価値事前予測入力を作る。 */
