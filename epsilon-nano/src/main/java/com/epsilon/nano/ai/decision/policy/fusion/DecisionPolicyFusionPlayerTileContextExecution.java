...
import com.epsilon.nano.ai.decision.policy.DecisionPolicyPlayerTileContextExecution;
import com.epsilon.nano.ai.decision.policy.EpsilonPlayerTileContextMixer;
import java.util.ArrayList;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * 4人の牌別文脈をdjl-rocmのPROJECTED_RESIDUAL_MLPで合成する凍結推論実行。
 *
 * <p>実行計画とパラメーターはパイプライン全体で共有し、各枠は最大 {@code [maxBatch,34,context]} の出力と準備処理 作業領域だけを持つ。{@code
 * maxBatch=4096}、{@code context=64}では、枠ごとの論理データ本体は FLOAT16/BFLOAT16で約68 MiB、FLOAT32で約136
