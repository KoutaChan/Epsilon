 ...
 *
 * <p>{@link #seal(DecisionTrainingBatchSummary)}は書き込み処理の所有権を消費し、変更不可な {@link
 * DecisionTrainingSealedHostBatch}へ移す。確定後の書き込み処理参照は使用してはならない。未完了利用権を閉じると位置を破棄してパイプラインへ返す。
 */
